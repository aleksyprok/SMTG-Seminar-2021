...
def r_and_t_fast(y, z, t, var):
    if var == 'ux':
        return ux0_p[2] * np.exp(1j * (ky * y + m_p[2] * z + omega * t)) * (z >= 0) + \
               ux0_m[3] * np.exp(1j * (ky * y + m_m[3] * z + omega * t)) * (z  < 0)
    elif var == 'u_perp':
        return u_perp0_p[2] * np.exp(1j * (ky * y + m_p[2] * z + omega * t)) * (z >= 0) + \
               u_perp0_m[3] * np.exp(1j * (ky * y + m_m[3] * z + omega * t)) * (z  < 0)
    elif var == 'bx':
        return bx0_p[2] * np.exp(1j * (ky * y + m_p[2] * z + omega * t)) * (z >= 0) + \
               bx0_m[3] * np.exp(1j * (ky * y + m_m[3] * z + omega * t)) * (z  < 0)
    elif var == 'b_perp':
        return b_perp0_p[2] * np.exp(1j * (ky * y + m_p[2] * z + omega * t)) * (z >= 0) + \
               b_perp0_m[3] * np.exp(1j * (ky * y + m_m[3] * z + omega * t)) * (z  < 0)
    elif var == 'b_par':
        return b_par0_p[2] * np.exp(1j * (ky * y + m_p[2] * z + omega * t)) * (z >= 0) + \
               b_par0_m[3] * np.exp(1j * (ky * y + m_m[3] * z + omega * t)) * (z  < 0)
    else:
...
output_dir = 'Figures/r_and_t_fast'
