...
def incident_wave(y, z, t, var):
    if var == 'ux':
        return ux0_p[0] * np.exp(1j * (ky * y + m_p[0] * z + omega * t)) * (z >= 0)
    elif var == 'u_perp':
        return u_perp0_p[0] * np.exp(1j * (ky * y + m_p[0] * z + omega * t)) * (z >= 0)
    elif var == 'bx':
        return bx0_p[0] * np.exp(1j * (ky * y + m_p[0] * z + omega * t)) * (z >= 0)
    elif var == 'b_perp':
        return b_perp0_p[0] * np.exp(1j * (ky * y + m_p[0] * z + omega * t)) * (z >= 0)
    elif var == 'b_par':
        return b_par0_p[0] * np.exp(1j * (ky * y + m_p[0] * z + omega * t)) * (z >= 0)
    else:
...
output_dir = 'Figures/incident_wave'
