...
def reflected_fast(y, z, t, var):
    if var == 'ux':
        return ux0[2] * np.exp(1j * (ky * y + kz[2] * z + omega * t))
    elif var == 'u_perp':
        return u_perp0[2] * np.exp(1j * (ky * y + kz[2] * z + omega * t))
    elif var == 'bx':
        return bx0[2] * np.exp(1j * (ky * y + kz[2] * z + omega * t))
    elif var == 'b_perp':
        return b_perp0[2] * np.exp(1j * (ky * y + kz[2] * z + omega * t))
    elif var == 'b_par':
        return b_par0[2] * np.exp(1j * (ky * y + kz[2] * z + omega * t))
    else:
...
output_dir = 'Figures/reflected_fast'
