...
def incident_wave(y, z, t, var):
    if var == 'ux':
        return ux0[0] * np.exp(1j * (ky * y + kz[0] * z + omega * t))
    elif var == 'u_perp':
        return u_perp0[0] * np.exp(1j * (ky * y + kz[0] * z + omega * t))
    elif var == 'bx':
        return bx0[0] * np.exp(1j * (ky * y + kz[0] * z + omega * t))
    elif var == 'b_perp':
        return b_perp0[0] * np.exp(1j * (ky * y + kz[0] * z + omega * t))
    elif var == 'b_par':
        return b_par0[0] * np.exp(1j * (ky * y + kz[0] * z + omega * t))
    else:
